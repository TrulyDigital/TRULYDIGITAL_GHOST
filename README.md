...
Realizar un tutorial con la explicación de como implementar un controlador, y todos sus detalles:
- Decorador @Controller()
- Ruta base del controlador
- Ruta de cada operación
- Métodos HTTP
- Código de Respuesta HTTP
- Objeto JSON de request
- Objeto JSON de respuesta
- Varios controladores e incluirlos en módulos
- Introducción a DTOs
...
|nestjs api rest|50|/nestjs/tutorial-nestjs/controladores/|
